...
class UserSeeder extends Seeder
{
    ...
    private static $firstCompanyUsers = [
        [
            ...
            'is_active' => 1,
            'first_name' => 'Norman',
            'last_name' => 'Osborn (Company Manager)',
            'name' => 'Norman Osborn (Company Manager)',
    ...
    private static $secondCompanyUsers = [
        [
            ...
            'is_active' => 1,
            'first_name' => 'Albert',
            'last_name' => 'Wesker (Company Manager)',
            'name' => 'Albert Wesker (Company Manager)',
            'access_to_all_entity' => 1,
            'theme' => 'theme-red'
        ],
        [
