...
class MenuManagerSeeder extends SeederHelper
{
    private static $_CRM_MENU = [
        ...
        ['id' => 25, 'order_by' => 4, 'url' => "#", 'label' => "sales", 'icon' => "my_location", 'permission' => "sales", 'parent_id' => null, 'section' => 1, 'visibility' => 1, 'dont_translate' => 0],
        ['id' => 30, 'order_by' => 5, 'url' => "#", 'label' => "support", 'icon' => "live_help", 'permission' => "support", 'parent_id' => null, 'section' => 1, 'visibility' => 1, 'dont_translate' => 0],
        ['id' => 33, 'order_by' => 6, 'url' => "#", 'label' => "inventory", 'icon' => "laptop", 'permission' => "inventory", 'parent_id' => null, 'section' => 1, 'visibility' => 1, 'dont_translate' => 0],
        ['id' => 34, 'order_by' => 7, 'url' => "#", 'label' => "others", 'icon' => "more", 'permission' => "others", 'parent_id' => null, 'section' => 1, 'visibility' => 1, 'dont_translate' => 0],
        ...
        ['id' => 20, 'order_by' => 3, 'url' => "#", 'label' => "marketing", 'icon' => "trending_up", 'permission' => "marketing", 'parent_id' => null, 'section' => 1, 'visibility' => 1, 'dont_translate' => 0],
        ...
        ['id' => 43, 'order_by' => 4, 'url' => "#", 'label' => "Activity", 'icon' => "work", 'permission' => "activity", 'parent_id' => null, 'section' => 1, 'visibility' => 1, 'dont_translate' => 1],
